...
@Component({
    selector: 'detail-line-chart-week-partners',
    template: `
    <div class="no-padding text-right chart-btn"><button type="button" class="umg__button btn" (click)="exportService.download('ArtistLineChartWeekPartners', exportService.lineChartWeekPartnersData, exportService.csvArtistLineChartWeekPartners)">Export Data<i class="fa fa-sign-out" aria-hidden="true" style="padding-left: 10px;"></i></button></div>
    <div id="detail-line-chart-week-partners" class="chart-week-partners"></div>`,
    styles: [`
      /deep/ #detail-line-chart-week-partners {
        position: relative;
        height: 0;
        width: 100%;
        padding: 0;
      ...
      /deep/ #detail-line-chart-week-partners > svg {
        position: absolute;
        height: 100%;
        width: 100%;
        left: 0;
...
export class DetailLineChartWeekPartnersComponent implements OnInit {
    ...
    constructor(public artistService: ArtistDetailService,
        ...
        this.filterEmit = fs.TestServiceEmit.subscribe(
            ...
            () => {
                ...
                d3.select(this.elem).select(".chart-week-partners svg").remove();
            });
    ...
    lineChartWeekPartners() {
		...
		this.svg = d3.select(this.elem).select('.chart-week-partners')
